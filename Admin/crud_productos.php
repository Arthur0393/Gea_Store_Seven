			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-xs-6">
							<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Productos</span></a>						
						</div>
					</div>
				</div>
...
?>
  <tr>
      ...
      <td><?php echo $mostrar['nombre_productos'] ?></td>
      <td><?php echo $mostrar['categoria_productos'] ?></td>
      <td><?php echo $mostrar['marca_productos'] ?></td>
      <td><?php echo $mostrar['precio_productos']?></td>
      <td><?php echo $mostrar['cantidad_productos']?></td>
      <td>
        <!----editar---->
